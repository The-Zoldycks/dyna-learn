...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['dyna-learn-doc-icon.png', 'dyna-learn-logo-blue.png', 'mahoraga-wheel.png', 'dyna-learn-icon-192.png', 'dyna-learn-icon-512.png', 'dyna-learn-icon-maskable-512.png'],
      manifest: {
        id: '/',
        ...
        icons: [
          {
            src: '/dyna-learn-icon-192.png',
            sizes: '192x192',
            type: 'image/png',
            purpose: 'any'
          },
          {
            src: '/dyna-learn-icon-512.png',
            sizes: '512x512',
            type: 'image/png',
            purpose: 'any'
          },
          {
            src: '/dyna-learn-icon-maskable-512.png',
            sizes: '512x512',
            type: 'image/png',
            purpose: 'maskable'
          }
